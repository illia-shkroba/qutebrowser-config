...
##    integration of *pipewire* and *alsa* is installed:
##    `sudo pacman -S pipewire-alsa`
## 2. Some userscripts require `dmenu`. Make sure it is installed.
## 3. A `qute-pass` userscript requires a non-tui `pinentry` program. Make sure
##    that an appropriate program is installed and configured in
##    *~/.local/share/gnupg/gpg-agent.conf*. For example:
...
config.bind("<Ctrl-B>", "cmd-run-with-count 25 scroll up")
# config.bind('<Ctrl-D>', 'scroll-page 0 0.5')
config.bind("<Ctrl-D>", "cmd-run-with-count 13 scroll down")
# config.bind('<Ctrl-F5>', 'reload -f')
# config.bind('<Ctrl-F>', 'scroll-page 0 1')
config.bind("<Ctrl-F>", "cmd-run-with-count 25 scroll down")
...
config.bind("g<Tab>", "tab-focus last")
config.bind("<Ctrl-Tab>", "nop")
...
config.bind(",D", "spawn --userscript qmenu --domain -- open -t")
config.bind(",d", "spawn --userscript qmenu --domain -- open")

config.bind(",C", "spawn --userscript qmenu --current -- open -t")
